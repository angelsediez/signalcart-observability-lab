# NginxEndpointDown Runbook

## Symptom

Blackbox Exporter cannot successfully probe the Nginx readiness endpoint.

## Impact

The user-facing HTTP entrypoint is unavailable or degraded.
