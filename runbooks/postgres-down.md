...
PostgreSQL or PostgreSQL Exporter reports unavailable.

## Impact

Database-backed requests and DB metrics may fail.
...
```text
start postgres and restart postgres-exporter if needed
```
